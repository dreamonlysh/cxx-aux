...
struct mpl_iterator_traits {
  ...
  static reference operator_dereference(Iterator iter) { return *iter; };

  static Iterator operator_arrow(Iterator iter) { return iter; }
...
public:
  ...
  template <typename U,
            typename = std::enable_if_t<ptr::const_of_v<U, pointer>>>
  ...
  pointer operator->() const noexcept { return Traits::operator_arrow(iter); }
  ...
  mpl_iterator operator++(int) noexcept { return mpl_iterator(iter++); }
  ...
  Iterator base() const noexcept { return iter; }
...
inline bool operator==(const mpl_iterator<T, Container>& lhs,
                       const mpl_iterator<T, Container>& rhs) noexcept {
  return lhs.base() == rhs.base();
}

template <typename T, typename U, typename Container,
          typename = std::enable_if_t<ptr::is_ncv_same_v<T, U>>>
inline bool operator==(const mpl_iterator<T, Container>& lhs,
                       const mpl_iterator<U, Container>& rhs) noexcept {
  return lhs.base() == rhs.base();
}
...
template <typename T, typename Container>
mpl_iterator<T, Container>
operator+(const mpl_iterator<T, Container>& iter,
...
template <typename T, typename Container>
mpl_iterator<T, Container>
operator+(typename mpl_iterator<T, Container>::difference_type n,
...
template <typename T, typename Container>
inline auto operator-(const mpl_iterator<T, Container>& lhs,
                      const mpl_iterator<T, Container>& rhs) noexcept ->
